...
class MessageCacheReloadTest {
	...
	void shouldClearAllCacheLevelsOnReload() {
		CacheKey key1 = new CacheKey("key1", "en_US", Map.of());
		CacheKey key2 = new CacheKey("key2", "en_US", Map.of());
		CacheKey key3 = new CacheKey("key3", "en_US", Map.of());
	...
	void shouldAllowRecachingAfterReload() {
		CacheKey key = new CacheKey("key", "en_US", Map.of());
