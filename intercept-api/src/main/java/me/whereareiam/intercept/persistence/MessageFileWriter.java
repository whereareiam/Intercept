package me.whereareiam.intercept.persistence;
...
public interface MessageFileWriter {
	...
	/**
	 * Persist the provided persistence data at the resolved output path with format id.
	 *
	 * @param relativePath path relative to the messages root (without extension)
	 * @param fileData     serialized message data to write
	 * @param formatId     format id for serialization
	 */
	default void write(String relativePath, MessageFileData fileData, String formatId) {
	...
	/**
	 * Persist the provided persistence data under a namespace with format id.
	 *
	 * @param namespace    message namespace
	 * @param relativePath path relative to the messages root (without extension)
	 * @param fileData     serialized message data to write
	 * @param formatId     format id for serialization
	 */
	default void write(String namespace, String relativePath, MessageFileData fileData, String formatId) {
		write(relativePath, fileData, formatId);
	}
