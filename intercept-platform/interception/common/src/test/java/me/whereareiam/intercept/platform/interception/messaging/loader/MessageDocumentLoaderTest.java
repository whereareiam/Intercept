...
class MessageDocumentLoaderTest {
	...
	void shouldLoadSingleLanguageMessage() {
		...
		assertEquals("Welcome!", translationService.resolve("test.welcome", Locale.ENGLISH));
	...
	void shouldConvertArrayToMultiLineText() {
		...
		assertEquals("Line 1\nLine 2\nLine 3", translationService.resolve("test.banner", Locale.ENGLISH));
	}
	...
	void shouldConvertArrayTranslations() {
		...
		MessageFileData.Entry entry = new MessageFileData.Entry();
		entry.setLocales(Map.of(
				"en", MessageValue.lines(List.of("Line 1", "Line 2")),
		...
		assertEquals("Line 1\nLine 2", translationService.resolve("test.banner", Locale.ENGLISH));
	...
	void shouldDetectMessageTypeFromLocales() {
		...
		msgEntry.setLocales(Map.of("en", MessageValue.text("Text")));
	...
	void shouldHandleMultipleTranslations() {
		...
		assertEquals("Hello", translationService.resolve("test.greeting", Locale.ENGLISH));
