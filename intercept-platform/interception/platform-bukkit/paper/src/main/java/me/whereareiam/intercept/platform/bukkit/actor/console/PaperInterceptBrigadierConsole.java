 ...
 */
@Getter
public class PaperInterceptBrigadierConsole extends AbstractPaperInterceptConsole {
	/**
	...
	/**
	 * Creates a new PaperInterceptBrigadierConsole wrapping a console sender with its CommandSourceStack.
	 *
	 * @param consoleSender      The Bukkit console sender
	 * @param commandSourceStack The original CommandSourceStack
	 */
	public PaperInterceptBrigadierConsole(@NotNull ConsoleCommandSender consoleSender, @NotNull CommandSourceStack commandSourceStack) {
		super(consoleSender);
