...
/**
 * Oraylen platform implementation of path resolution for translation defaults.
 * Delegates to TranslationPathResolver for format-specific operations.
 */
@RequiredArgsConstructor
public final class OraylenDefaultsPathResolver implements DefaultsPathResolver {
    ...
    @Override
    public Path resolveDefaultFilePath(Path baseDirectory, String rawPath, String fallbackName, Locale defaultLocale) {
        if (rawPath == null || rawPath.isBlank()) return null;
