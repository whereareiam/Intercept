...
public interface TemplatePathResolver {
    ...
    /**
     * Resolve target path for a template file with a fallback name.
     *
     * @param baseDirectory base directory for relative paths
     * @param rawPath       raw path from source configuration (may contain globs)
     ...
     * @return resolved target path, or null if resolution fails
     */
    Path resolveTemplatePath(Path baseDirectory, String rawPath, String fallbackName, Locale defaultLocale);
