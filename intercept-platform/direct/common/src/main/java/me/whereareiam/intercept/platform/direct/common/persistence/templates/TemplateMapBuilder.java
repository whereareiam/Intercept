...
/**
 * Utility for building and transforming translation template data structures.
 */
public final class TemplateMapBuilder {
    /**
     * Build locale-keyed templates from raw generated data.
     ...
     */
    public static Map<Locale, Map<String, Object>> buildLocaleTemplates(
    ...
    /**
     * Build a single template map from locale-keyed data.
     ...
     * @return template values map for the chosen locale
     */
    public static Map<String, Object> buildDefaultTemplateMap(
            Map<Locale, Map<String, Object>> generated,
        ...
        Map<String, Object> templates = generated.get(defaultLocale);
        if (templates == null) templates = generated.values().iterator().next();
    ...
    /**
     * Build a multi-locale template map, restructuring from locale-first to key-first format.
     ...
     */
    public static Map<String, Object> buildMultiLocaleTemplateMap(
            Map<Locale, Map<String, Object>> generated,
        ...
        for (Map.Entry<Locale, Map<String, Object>> localeEntry : generated.entrySet()) {
            ...
            mergeLocaleTemplates(output, localeKey, values);
        }
     ...
     */
    private static void mergeLocaleTemplates(Map<String, Object> target, String localeKey, Map<?, ?> values) {
        for (Map.Entry<?, ?> entry : values.entrySet()) {
            String key = String.valueOf(entry.getKey());
            Object value = entry.getValue();
            if (value instanceof Map<?, ?> nested) {
                Map<String, Object> child = ensureChildMap(target, key);
                mergeLocaleTemplates(child, localeKey, nested);
            } else {
